...
* 🔥 **FAIL** head version is "1.00700" while name version string (for platform 3, encoding 1) is "Version 1.004; ttfautohint (v1.8.4.7-5d5b)". [code: mismatch]
